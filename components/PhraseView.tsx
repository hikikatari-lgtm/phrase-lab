...
import { C, freq, roleColor } from "@/lib/music";
import type { Phrase } from "@/lib/types";

// Phrase を受け取って描画する純粋なビュー（データ駆動）。
// 再生ロジック（Web Audio, setTimeout ハイライト, clearTimeout）を内包。
    ...
    >
      ...
      <div style={{ maxWidth: 560, margin: "0 auto" }}>
        ...
        <div style={{ background: C.surface, border: `1px solid ${C.line}`, borderRadius: 14, padding: "15px 16px", marginBottom: 14 }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: C.amber, marginBottom: 4 }}>{phrase.positionLabel}</div>
          ...
          <Fretboard scale={SCALE} lick={[]} hot={-1} fretRange={phrase.fretRange} />
        </div>
