...
export const gmixoArp: Phrase = {
  ...
  // フレーズ（CD Track 21）。写真のタブ譜どおりの運指。resolve=解決音（青）。
  // 度数の流れ：R → △3 → 5 → ♭7 → 9 → 4 → △3 → 9 →（CΔ7の5th=Gへ解決）。すべて16分音符。
  licks: [
    {
      name: "アルペジオ・フレーズ",
      note: "5弦root(G)から R-△3-5-♭7-9-4-△3-9 と16分でアルペジオ上行 / 1弦8f→7fはスライド(S.) → 2弦8f(G)でCΔ7の5th(P5)へ解決",
      seq: [
